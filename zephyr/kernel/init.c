...
static FUNC_NORETURN void switch_to_main_thread(char *stack_ptr)
{
	...
	printascii("ARG_UNUSED(stack_ptr); before! \r\n");
#endif
	 ...
	 */
	#if defined(CONFIG_SOC_RK3568) && defined(CONFIG_NS16650_EARLYPRINT_DEBUG)
	printascii("z_swap_unlocked(); before\r\n");
    #endif
	z_swap_unlocked();
	#if defined(CONFIG_SOC_RK3568) && defined(CONFIG_NS16650_EARLYPRINT_DEBUG)
	printascii("z_swap_unlocked(); after \r\n");
    #endif
#endif
...
#if defined(CONFIG_SOC_RK3568) && defined(CONFIG_NS16650_EARLYPRINT_DEBUG)
	printascii("Init rk3568 device managment successful! \r\n");
#endif
...
#if defined(CONFIG_SOC_RK3568) && defined(CONFIG_NS16650_EARLYPRINT_DEBUG)
	printascii("CONFIG_MULTITHREADING before! \r\n");
#endif
